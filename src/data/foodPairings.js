...
function detectFood(query) {
  ...
  for (const pairing of sorted) {
    for (const kw of pairing.keywords) {
      if (q.includes(normalize(kw))) return pairing;
    }
  }
  return null;
}
...
const FOOD_PAIRINGS = [
  ...
  // ═══ GIBIER ══════════════════════════════════════════════════════════════════
  {
    id: 'gibier_poil', label: 'Gibier à poil', group: 'Viandes & volailles', priority: 96,
    keywords: ['chevreuil','sanglier','cerf','biche','lièvre','lievre','venaison','marcassin','daim','gibier a poil'],
    ...
    regionsBonus: [
      ...
      { pattern: 'saint-emilion', bonus: 16 }, { pattern: 'bourgogne', bonus: 14 }, { pattern: 'rhone', bonus: 12 },
    ],
  },
  {
    id: 'gibier_plume', label: 'Gibier à plume', group: 'Viandes & volailles', priority: 92,
    keywords: ['faisan','perdrix','perdreau','becasse','bécasse','caille','pigeon ramier','pintade sauvage','canard sauvage','gibier a plume'],
    ...
    regionsBonus: [
      { pattern: 'bourgogne', bonus: 20 }, { pattern: 'bordeaux', bonus: 14 }, { pattern: 'rhone', bonus: 10 },
    ],
  },
  ...
  // ═══ VIANDES ROUGES ══════════════════════════════════════════════════════════
  {
    ...
    regionsBonus: [
      ...
      { pattern: 'languedoc', bonus: 12 }, { pattern: 'cahors', bonus: 12 }, { pattern: 'roussillon', bonus: 10 },
    ],
  },
  {
    id: 'viande_rouge_mijotee', label: 'Viande rouge mijotée / braisée', group: 'Viandes & volailles', priority: 82,
    keywords: ['bourguignon','boeuf bourguignon','bœuf bourguignon','daube','ragout','ragoût','braise','braisé','joue de boeuf','joue de bœuf','pot-au-feu','pot au feu','carbonade','boeuf mijote','bœuf mijoté','osso buco','jarret de boeuf','paleron','queue de boeuf','boeuf carotte','bœuf carottes','mijoté','mijoté de'],
  ...
  {
    id: 'agneau', label: 'Agneau', group: 'Viandes & volailles', priority: 84,
    keywords: ['agneau','gigot','carre d agneau','carré d\'agneau','epaule d agneau','cotelette d agneau','agneau roti','agneau grille','navarin'],
    ...
    regionsBonus: [
      ...
      { pattern: 'pauillac', bonus: 22 }, { pattern: 'rhone', bonus: 14 }, { pattern: 'provence', bonus: 10 },
    ],
  },
  {
    id: 'viande_blanche', label: 'Viande blanche (veau, porc, lapin)', group: 'Viandes & volailles', priority: 71,
    keywords: ['veau','escalope de veau','roti de veau','rôti de veau','blanquette de veau','porc','filet mignon de porc','cotes de porc','roti de porc','rôti de porc','travers de porc','ribs','lapin','roti de lapin','rôti de lapin'],
  ...
  // ═══ VOLAILLES ═══════════════════════════════════════════════════════════════
  {
    id: 'poulet_roti', label: 'Poulet rôti', group: 'Viandes & volailles', priority: 73,
    keywords: ['poulet roti','poulet rôti','poulet fermier','poulet au four','demi-poulet','cuisse de poulet rotie','poulet entier'],
    ...
    regionsBonus: [
      { pattern: 'bourgogne', bonus: 18 }, { pattern: 'beaujolais', bonus: 12 }, { pattern: 'alsace', bonus: 8 },
    ],
  },
  {
    id: 'canard', label: 'Canard (magret, confit)', group: 'Viandes & volailles', priority: 80,
    keywords: ['canard','magret','magret de canard','confit de canard','canard confit','canard a l orange','canard à l\'orange','canard roti','canard rôti','aiguillettes de canard','parmentier canard'],
  ...
  {
    id: 'volaille_sauce_creme', label: 'Volaille en sauce crémeuse', group: 'Viandes & volailles', priority: 74,
    keywords: ['poulet a la creme','poulet crème','volaille a la creme','fricassee','fricassée','blanquette de poulet','dinde a la creme','poulet aux champignons','vol-au-vent','supreme de volaille','poulet sauce'],
  ...
  {
    id: 'foie_gras', label: 'Foie gras', group: 'Charcuterie & terrines', priority: 95,
    keywords: ['foie gras','foie-gras','mi-cuit','mi cuit','torchon foie','foie gras poele','foie gras d\'oie','foie gras de canard','escalope de foie gras'],
    ...
    regionsBonus: [
      ...
      { pattern: 'monbazillac', bonus: 20 }, { pattern: 'alsace', bonus: 16 }, { pattern: 'coteaux du layon', bonus: 18 },
    ],
  },
  {
    id: 'charcuterie', label: 'Charcuterie & saucissons', group: 'Charcuterie & terrines', priority: 66,
    keywords: ['charcuterie','jambon cru','jambon sec','saucisson','rosette','coppa','pancetta','salami','prosciutto','serrano','rillettes','rillette','lard','lardon','bacon','jambon blanc'],
  ...
  {
    id: 'terrine_pate', label: 'Terrine & pâté de campagne', group: 'Charcuterie & terrines', priority: 68,
    keywords: ['terrine','pate de campagne','pâté de campagne','pate en croute','pâté en croûte','rillons','boudin','andouille','andouillette'],
  ...
  {
    id: 'poisson_gras', label: 'Poisson gras (saumon, thon)', group: 'Poissons & fruits de mer', priority: 78,
    keywords: ['saumon','saumon fume','saumon grille','pave de saumon','thon','thon rouge','thon grille','tataki de thon','maquereau','sardine','hareng','anguille','espadon','truite fumee','poisson gras','poisson fume'],
    ideal:      { couleurs: ['blanc'], regionsPreferees: ['Bourgogne','Alsace','Jura'] },
    bon:        { couleurs: ['rosé'] },
    acceptable: { couleurs: ['effervescent'] },
  ...
  {
    id: 'poisson_sauce', label: 'Poisson en sauce crémeuse', group: 'Poissons & fruits de mer', priority: 79,
    keywords: ['sole meuniere','sole meuniére','poisson a la creme','poisson creme','brandade','gratin de poisson','blanquette de poisson','beurre blanc','poisson beurre blanc'],
  ...
  {
    id: 'bouillabaisse', label: 'Bouillabaisse & soupe de poisson', group: 'Poissons & fruits de mer', priority: 85,
    keywords: ['bouillabaisse','soupe de poisson','soupe poisson','bisque','bisque de homard','bourride'],
    ...
    regionsBonus: [
      { pattern: 'bandol', bonus: 24 }, { pattern: 'cassis', bonus: 22 }, { pattern: 'provence', bonus: 16 },
    ],
  },
  {
    id: 'huitres_mer_crus', label: 'Huîtres & fruits de mer crus', group: 'Poissons & fruits de mer', priority: 88,
    keywords: ['huitre','huître','huitres','huîtres','fruits de mer','fruits de mer crus','plateau de fruits de mer','coquillage','coquillages','crabe','araignee de mer','araignée de mer','crevette crue','palourde crue','bulot','bigorneaux'],
  ...
  {
    id: 'crustaces_cuits', label: 'Homard, saint-jacques & crustacés cuisinés', group: 'Poissons & fruits de mer', priority: 86,
    keywords: ['homard','langouste','langoustine','crevettes','crevette','crevettes cuites','gambas','crustaces','crustace','crustacés','crustacé','coquille saint-jacques','saint-jacques','noix de saint-jacques','risotto saint-jacques','moules','moule mariniere','palourdes sautees'],
    ...
    regionsBonus: [
      ...
      { pattern: 'champagne', bonus: 20 }, { pattern: 'bourgogne', bonus: 16 }, { pattern: 'pessac', bonus: 16 },
    ],
  },
  {
    id: 'sushi_sashimi', label: 'Sushi, sashimi & cuisine japonaise', group: 'Poissons & fruits de mer', priority: 90,
    keywords: ['sushi','sashimi','maki','california roll','temaki','nigiri','japonais','cuisine japonaise','omakase'],
  ...
  // ═══ CUISINE DU MONDE — MAGHREB ═══════════════════════════════════════════════
  {
    id: 'tajine_agneau', label: 'Tajine d\'agneau', group: 'Cuisine du monde', priority: 90,
    keywords: ['tajine agneau','tagine agneau','tajine d\'agneau','tagine d agneau','tajine agneau pruneaux','tajine agneau citron'],
    ideal:      { couleurs: ['rouge'], regionsPreferees: ['Rhône','Languedoc','Roussillon','Provence'] },
    bon:        { couleurs: ['rosé'] },
    acceptable: { couleurs: ['blanc'] },
    eviter:     { couleurs: ['effervescent','moelleux'], raison: "Les épices douces et la viande confite du tajine s'accordent avec la chaleur et le fruit d'un rouge souple." },
    texteIdeal:     "Le tajine d'agneau appelle un rouge souple et fruité du sud de la France : Côtes du Rhône, Gigondas, Languedoc, Corbières.",
    texteBon:       "Un rosé sec et charnu peut fonctionner, surtout pour les tajines citronnés légers.",
    texteCompromis: "Un blanc manque de chaleur pour s'accorder avec les épices et la viande confite.",
    texteAchat:     "un rouge du Rhône sud (Gigondas, Vacqueyras, Châteauneuf-du-Pape) ou un Languedoc",
    regionsBonus: [
      { pattern: 'rhone', bonus: 18 }, { pattern: 'gigondas', bonus: 22 }, { pattern: 'vacqueyras', bonus: 22 },
      { pattern: 'chateauneuf', bonus: 24 }, { pattern: 'languedoc', bonus: 18 },
      { pattern: 'corbieres', bonus: 20 }, { pattern: 'minervois', bonus: 18 }, { pattern: 'roussillon', bonus: 14 },
    ],
  },
  {
    id: 'tajine_poulet_legumes', label: 'Tajine de poulet ou de légumes', group: 'Cuisine du monde', priority: 88,
    keywords: ['tajine poulet','tagine poulet','tajine legumes','tajine légumes','tajine citron','tajine kefta','tajine','tagine'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Rhône','Languedoc','Provence'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['effervescent','moelleux'] },
    texteIdeal:     "Le tajine de poulet accepte aussi bien un rouge souple du Rhône qu'un rosé sec et fruité de Provence.",
    ...
    regionsBonus: [
      { pattern: 'rhone', bonus: 16 }, { pattern: 'provence', bonus: 14 }, { pattern: 'languedoc', bonus: 14 },
    ],
  },
  {
    id: 'couscous', label: 'Couscous', group: 'Cuisine du monde', priority: 87,
    keywords: ['couscous','couscous royal','couscous mouton','couscous merguez','couscous legumes','couscous poulet'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Languedoc','Rhône','Roussillon'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['effervescent','moelleux'] },
    texteIdeal:     "Le couscous royal appelle un rouge fruité du Languedoc (Corbières, Minervois) ou un rosé sec et charnu.",
    ...
    regionsBonus: [
      ...
      { pattern: 'corbieres', bonus: 20 }, { pattern: 'minervois', bonus: 20 }, { pattern: 'provence', bonus: 14 },
    ],
  },
  {
    id: 'merguez_grillade_epicee', label: 'Grillades épicées & merguez', group: 'Cuisine du monde', priority: 80,
    keywords: ['merguez','merguez grillee','chipolata epicee','saucisse epicee','brochette epicee','grillade epicee','chorizo grille','mechoui','méchoui'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Languedoc','Rhône','Roussillon'] },
    bon:        { couleurs: [] },
    acceptable: { couleurs: ['blanc'] },
    eviter:     { couleurs: ['effervescent','moelleux'] },
    texteIdeal:     "Les grillades épicées et merguez appellent un rouge fruité et charnu, ou un rosé sec et gras.",
  ...
  {
    id: 'curry_doux', label: 'Curry doux & tikka masala', group: 'Cuisine du monde', priority: 87,
    keywords: ['tikka masala','curry doux','korma','butter chicken','chicken tikka','masala','curry creme','curry lait de coco','colombo','saag'],
    ideal:      { couleurs: ['blanc'], regionsPreferees: ['Alsace','Loire'] },
    bon:        { couleurs: ['rosé'] },
    acceptable: { couleurs: ['rouge'] },
    eviter:     { couleurs: ['effervescent','moelleux'] },
    texteIdeal:     "Les currys doux et crémeux s'accordent magnifiquement avec un Gewurztraminer ou un Riesling demi-sec d'Alsace.",
    ...
    regionsBonus: [
      { pattern: 'alsace', bonus: 24 }, { pattern: 'vouvray', bonus: 16 }, { pattern: 'rhone', bonus: 10 },
    ],
  },
  {
    id: 'curry_fort_biryani', label: 'Curry fort, biryani & cuisine indienne épicée', group: 'Cuisine du monde', priority: 88,
    keywords: ['vindaloo','curry fort','curry epice','madras','curry rouge thai','curry vert','piment fort','tres epicee','biryani','biryani epice','indien','indienne'],
    ...
    texteIdeal:     "Pour les currys très épicés, un rosé sec et frais ou un Riesling sec d'Alsace tempèrent les épices.",
  ...
  {
    id: 'wok_asiatique', label: 'Wok, noodles & cuisine asiatique légère', group: 'Cuisine du monde', priority: 77,
    keywords: ['wok','chow mein','pad thai','pad thaï','noodles','pho','ramen','udon','bo bun','nems','dim sum','dumplings','gyoza','rouleaux de printemps','poke bowl','bowl asiatique','nouilles asiatiques','vietnamien','vietnamienne','chinois','chinoise'],
    ideal:      { couleurs: ['blanc','effervescent','rosé'], regionsPreferees: ['Alsace','Loire','Champagne'] },
    bon:        { couleurs: [] },
    acceptable: { couleurs: ['rouge'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "La cuisine asiatique légère s'accorde avec un blanc aromatique et vif (Riesling, Pinot Gris d'Alsace) ou un effervescent rafraîchissant.",
    ...
    regionsBonus: [
      { pattern: 'alsace', bonus: 20 }, { pattern: 'champagne', bonus: 16 }, { pattern: 'loire', bonus: 14 },
    ],
  },
  {
    id: 'thai_epicee', label: 'Cuisine thaïlandaise épicée', group: 'Cuisine du monde', priority: 82,
    keywords: ['thai','thaï','thaïlandais','thaie','soupe thaï','salade thaie','larb','som tam','pad see ew'],
    ideal:      { couleurs: ['blanc','rosé'], regionsPreferees: ['Alsace','Provence'] },
    bon:        { couleurs: [] },
    acceptable: { couleurs: ['effervescent'] },
    eviter:     { couleurs: ['rouge','moelleux'] },
    texteIdeal:     "La cuisine thaïlandaise s'accorde idéalement avec un blanc aromatique légèrement sucré (Riesling demi-sec, Gewurztraminer) ou un rosé frais.",
  ...
  {
    id: 'pizza', label: 'Pizza', group: 'Cuisine du monde', priority: 72,
    keywords: ['pizza','pizza margherita','pizza napolitaine','pizza 4 fromages','pizza reine','pizza calzone','flatbread'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Languedoc','Rhône','Provence'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: ['effervescent'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "La pizza se marie idéalement avec un rouge fruité peu tannique (Côtes du Rhône, Languedoc) ou un rosé de Provence.",
    ...
    regionsBonus: [
      { pattern: 'rhone', bonus: 15 }, { pattern: 'languedoc', bonus: 14 }, { pattern: 'provence', bonus: 14 },
    ],
  },
  {
    id: 'paella_espagnol', label: 'Paella & cuisine espagnole', group: 'Cuisine du monde', priority: 79,
    keywords: ['paella','paella valencienne','paella fruits de mer','paella mixte','tapas','patatas bravas','tortilla espagnole','cuisine espagnole','espagnol','espagnole'],
    ideal:      { couleurs: ['rosé','blanc','rouge'], regionsPreferees: ['Provence','Languedoc','Rhône'] },
    bon:        { couleurs: ['effervescent'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "La paella appelle la légèreté d'un rosé sec ou d'un blanc vif.",
    ...
    regionsBonus: [
      { pattern: 'provence', bonus: 14 }, { pattern: 'languedoc', bonus: 14 }, { pattern: 'rhone', bonus: 12 },
    ],
  },
  {
    id: 'cuisine_libanaise', label: 'Cuisine libanaise & mezze', group: 'Cuisine du monde', priority: 80,
    keywords: ['mezze','houmous','hummus','taboulé','tabboulé','fattoush','shawarma','kefta','kafta','falafel','libanais','libanaise','labneh','baba ganoush','kibbeh'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Languedoc','Rhône','Provence'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: ['effervescent'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "La cuisine libanaise s'accorde avec un rosé sec de Méditerranée ou un rouge fruité du Languedoc.",
    ...
    regionsBonus: [
      { pattern: 'languedoc', bonus: 15 }, { pattern: 'rhone', bonus: 14 }, { pattern: 'provence', bonus: 14 },
    ],
  },
  {
    id: 'tex_mex', label: 'Tex-Mex & cuisine mexicaine', group: 'Cuisine du monde', priority: 73,
    keywords: ['tacos','taco','burrito','fajita','enchilada','nachos','guacamole','quesadilla','tex-mex','mexicain','chili con carne','chili','burritos'],
    ideal:      { couleurs: ['rouge','rosé'], regionsPreferees: ['Languedoc','Rhône','Roussillon'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: ['effervescent'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "Le tex-mex se marie bien avec un rouge fruité (Merlot, Côtes du Rhône) ou un rosé sec.",
    ...
    regionsBonus: [
      { pattern: 'languedoc', bonus: 14 }, { pattern: 'rhone', bonus: 12 }, { pattern: 'provence', bonus: 10 },
    ],
  },

  // ═══ FROMAGES ═════════════════════════════════════════════════════════════════
  {
    id: 'fromage_chevre', label: 'Fromage de chèvre', group: 'Fromages', priority: 88,
    keywords: ['chevre','chèvre','chevre chaud','crottin','crottin de chavignol','sainte-maure','valencay','valençay','pelardon','picodon','banon','buchette chevre','fromage de chevre'],
    ...
    texteIdeal:     "L'accord chèvre–Sancerre est l'un des plus classiques — l'acidité du Sauvignon Blanc répond parfaitement à l'acidité du chèvre.",
    ...
    regionsBonus: [
      ...
      { pattern: 'menetou', bonus: 20 }, { pattern: 'quincy', bonus: 20 }, { pattern: 'loire', bonus: 14 },
    ],
  },
  {
    id: 'fromage_bleu', label: 'Fromage bleu (roquefort, gorgonzola)', group: 'Fromages', priority: 89,
    keywords: ['roquefort','bleu d\'auvergne','bleu de gex','fourme d\'ambert','gorgonzola','stilton','danish blue','bleu','fromage bleu'],
    ideal:      { couleurs: ['moelleux'], regionsPreferees: ['Sauternes','Jurançon','Banyuls'] },
    bon:        { couleurs: ['rouge'] },
    acceptable: { couleurs: ['blanc'] },
    eviter:     { couleurs: ['effervescent','rosé'] },
    texteIdeal:     "L'accord Roquefort–Sauternes est légendaire. Un Jurançon moelleux ou un Porto blanc fonctionnent aussi.",
  ...
  {
    id: 'fromage_pate_dure', label: 'Fromage à pâte dure (comté, beaufort)', group: 'Fromages', priority: 83,
    keywords: ['comte','comté','beaufort','abondance','cantal','salers','gruyere','gruyère','emmental','tomme','tomme de savoie','ossau-iraty','manchego','parmesan'],
    ideal:      { couleurs: ['blanc','rouge'], regionsPreferees: ['Jura','Savoie','Bourgogne'] },
    bon:        { couleurs: ['effervescent'] },
    acceptable: { couleurs: ['rosé'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "Les fromages à pâte dure (comté, beaufort) s'accordent idéalement avec un blanc du Jura (Vin jaune, Chardonnay) ou un rouge léger de Bourgogne.",
    ...
    regionsBonus: [
      { pattern: 'jura', bonus: 24 }, { pattern: 'bourgogne', bonus: 18 }, { pattern: 'savoie', bonus: 20 },
    ],
  },
  {
    id: 'fromage_pate_molle', label: 'Fromage à pâte molle (brie, camembert)', group: 'Fromages', priority: 82,
    keywords: ['brie','camembert','coulommiers','chaource','neufchatel','saint-marcellin','reblochon','vacherin','fromage pate molle'],
    ...
    regionsBonus: [
      { pattern: 'beaujolais', bonus: 16 }, { pattern: 'champagne', bonus: 18 }, { pattern: 'bourgogne', bonus: 15 },
    ],
  },
  {
    id: 'fromage_fort', label: 'Fromage fort & puissant (munster, époisses)', group: 'Fromages', priority: 84,
    keywords: ['munster','maroilles','livarot','epoisses','époisse','langres','pont-l\'eveque','fromage fort','fromage tres affine'],
    ideal:      { couleurs: ['moelleux','rouge'], regionsPreferees: ['Alsace','Bourgogne','Jura'] },
    bon:        { couleurs: ['blanc'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['effervescent','rosé'] },
    texteIdeal:     "Les fromages forts (munster, maroilles, époisses) appellent un blanc aromatique puissant (Gewurztraminer d'Alsace) ou un rouge corsé.",
    ...
    regionsBonus: [
      { pattern: 'alsace', bonus: 22 }, { pattern: 'bourgogne', bonus: 18 }, { pattern: 'jura', bonus: 16 },
    ],
  },
  {
    id: 'plateau_fromages', label: 'Plateau de fromages', group: 'Fromages', priority: 73,
    keywords: ['plateau de fromages','assortiment fromages','selection fromages','fromages','fromage'],
  ...
  // ═══ PÂTES, RIZ & LÉGUMES ════════════════════════════════════════════════════
  {
    id: 'pates_tomate', label: 'Pâtes sauce tomate (bolognaise, arrabiata)', group: 'Pâtes, riz & légumes', priority: 69,
    keywords: ['bolognaise','pates bolognaise','pâtes bolognaise','lasagne','lasagnes','pates sauce tomate','pasta tomate','arrabiata','rigatoni','spaghetti','spaghetti bolognaise'],
  ...
  {
    id: 'pates_creameuses', label: 'Pâtes crèmeuses (carbonara, alfredo)', group: 'Pâtes, riz & légumes', priority: 71,
    keywords: ['carbonara','pates carbonara','pâtes carbonara','pates a la creme','penne creme','tagliatelle creme','cacio e pepe','pates creameuses'],
  ...
  {
    id: 'risotto', label: 'Risotto', group: 'Pâtes, riz & légumes', priority: 73,
    keywords: ['risotto','risotto champignons','risotto parmesan','risotto truffe','risotto poulet','risotto aux asperges'],
    ideal:      { couleurs: ['blanc'], regionsPreferees: ['Bourgogne','Alsace','Jura'] },
    bon:        { couleurs: ['rouge','rosé'] },
    acceptable: { couleurs: ['effervescent'] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "Le risotto (crémeux et riche) s'accorde idéalement avec un blanc gras et structuré (Bourgogne, Jura).",
    ...
    regionsBonus: [
      { pattern: 'bourgogne', bonus: 20 }, { pattern: 'jura', bonus: 16 }, { pattern: 'alsace', bonus: 14 },
    ],
  },
  {
    id: 'vegetarien_leger', label: 'Salade & légumes légers', group: 'Pâtes, riz & légumes', priority: 62,
    keywords: ['salade verte','salade composee','legumes grilles','legumes vapeur','ratatouille','caponata','primeurs','crudites','bruschetta tomate','poivrons grilles','courgettes grillees','buddha bowl','salade nicoise'],
    ...
    regionsBonus: [
      { pattern: 'sancerre', bonus: 16 }, { pattern: 'muscadet', bonus: 14 }, { pattern: 'provence', bonus: 14 },
    ],
  },
  {
    id: 'gratin_fondue_raclette', label: 'Gratin, fondue & raclette', group: 'Pâtes, riz & légumes', priority: 77,
    keywords: ['gratin dauphinois','gratin','fondue savoyarde','fondue','raclette','tartiflette','croziflette','aligot','rösti','rosti'],
    ...
    regionsBonus: [
      { pattern: 'savoie', bonus: 24 }, { pattern: 'jura', bonus: 18 }, { pattern: 'alsace', bonus: 14 },
    ],
  },
  ...
  // ═══ DESSERTS ════════════════════════════════════════════════════════════════
  {
    ...
    texteIdeal:     "L'accord Chocolat noir–Banyuls est canonique. Ce vin doux naturel du Roussillon partage avec le chocolat amer des notes de fruits noirs et de café.",
  ...
  {
    id: 'dessert_chocolat_lait', label: 'Tiramisu & desserts chocolat lait', group: 'Desserts', priority: 83,
    keywords: ['chocolat au lait','tiramisu','profiteroles','eclair chocolat','paris-brest','mousse chocolat lait'],
    ...
    regionsBonus: [
      { pattern: 'champagne', bonus: 18 }, { pattern: 'sauternes', bonus: 20 }, { pattern: 'loire', bonus: 16 },
    ],
  },
  {
    id: 'dessert_fruits_rouges', label: 'Desserts aux fruits rouges', group: 'Desserts', priority: 81,
    keywords: ['fraises','framboises','tarte aux fraises','tarte framboises','charlotte aux fruits rouges','coulis framboises','sorbet fruits rouges','pavlova fruits rouges','fruits rouges'],
  ...
  {
    id: 'tarte_fruits', label: 'Tarte aux fruits & crumble', group: 'Desserts', priority: 79,
    keywords: ['tarte aux pommes','tarte tatin','crumble','clafoutis','far breton','gateau aux poires','tarte poire','tarte abricot','tarte aux prunes','compote','chausson aux pommes','tarte mirabelle'],
  ...
  {
    id: 'dessert_creme', label: 'Crème brûlée & desserts lactés', group: 'Desserts', priority: 79,
    keywords: ['creme brulee','crème brûlée','panna cotta','ile flottante','flan','creme caramel','millefeuille','saint-honore','glace vanille','glace','baba au rhum'],
    ideal:      { couleurs: ['moelleux','effervescent'], regionsPreferees: ['Sauternes','Loire','Champagne'] },
    bon:        { couleurs: ['rosé'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['rouge','blanc'] },
    ...
    regionsBonus: [
      { pattern: 'sauternes', bonus: 24 }, { pattern: 'champagne', bonus: 18 }, { pattern: 'loire', bonus: 16 },
    ],
  },

  // ═══ APÉRITIF ════════════════════════════════════════════════════════════════
  {
    id: 'aperitif', label: 'Apéritif & amuse-gueules', group: 'Apéritif', priority: 65,
    keywords: ['aperitif','apéritif','apero','apéro','chips','cacahuetes','olives','gougeres','canapes','blinis','verrines','amuse-gueules','toast','crackers','petits fours sales'],
    ideal:      { couleurs: ['effervescent','rosé','blanc'], regionsPreferees: ['Champagne','Provence','Loire'] },
    bon:        { couleurs: ['rouge'] },
    acceptable: { couleurs: [] },
    eviter:     { couleurs: ['moelleux'] },
    texteIdeal:     "L'apéritif appelle légèreté et fraîcheur : Champagne, Crémant, rosé de Provence sec ou un blanc vif.",
    ...
    regionsBonus: [
      ...
      { pattern: 'alsace', bonus: 16 }, { pattern: 'loire', bonus: 14 }, { pattern: 'beaujolais', bonus: 12 },
    ],
  },
];

module.exports = { detectFood, FOOD_PAIRINGS };
